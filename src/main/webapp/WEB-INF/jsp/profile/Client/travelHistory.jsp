	...
	<div class="container">
		<div class="row justify-content-center align-items-center">
			<c:forEach var="th" items="${travelHistory}">
				<form method="get" action="review" class="card me-5 mt-3"
					...
					<div class="card-body">
						...
						<input type="hidden" name="dataPartenza"
							value="${th.dataPartenza}">
						<p class="card-text">Partenza: ${th.dataPartenza}</p>

						<input type="hidden" name="stazionePartenza" value="${th.startS}">
						<input type="hidden" name="orarioPartenza"
							value="${th.departureTime}">
						...
						<input type="hidden" name="stazioneArrivo"
							value="${th.destinationS}"> <input type="hidden"
							name="orarioArrivo" value="${th.arrivalTime}"> <input
							type="hidden" name="cod" value="${th.cod}"> <input
						...
						<div class="row">
							...
							<div class="col">
								<button type="submit" class="badge btn" id="recensione"
									onclick="window.location.href = '/review'"
									style="margin: 0px 0px 0px 0px">RECENSISCI</button>
							</div>
